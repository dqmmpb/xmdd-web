  ...
  'use strict';
    var Swiper = function (container, params) {
        ...
        function setParallaxTransform(el, progress) {
          ...
          pP = el.attr('data-swiper-parallax') || '0';
        ...
        s.off = function (eventName, handler) {
            ...
            if (!s.emitterEventListeners[eventName] || s.emitterEventListeners[eventName].length === 0) return s;
            for (i = 0; i < s.emitterEventListeners[eventName].length; i++) {
...
(function($){
    ...
    var PhotoBrowser = function (params) {
        ...
        pb.onSlideTouchMove = function (e) {
            ...
            imageTouchesCurrent.x = e.type === 'touchmove' ? e.originalEvent.targetTouches[0].pageX : e.pageX;
            imageTouchesCurrent.y = e.type === 'touchmove' ? e.originalEvent.targetTouches[0].pageY : e.pageY;
        ...
        pb.swipeCloseTouchMove = function (swiper, e) {
            ...
            if (!swipeToCloseStarted) {
                ...
                swipeToCloseStart = e.type === 'touchmove' ? e.originalEvent.targetTouches[0].pageY : e.pageY;
                swipeToCloseActiveSlide = pb.swiper.slides.eq(pb.swiper.activeIndex);
                swipeToCloseTimeStart = (new Date()).getTime();
            }
            e.preventDefault();
            swipeToCloseCurrent = e.type === 'touchmove' ? e.originalEvent.targetTouches[0].pageY : e.pageY;
